...
# The line below sets a vector for years from 1-8
time_yr <- seq(from = 0, to = 8, by = 1)

# The line below creates a matrix over the length of the project with the length of yrs(8 yrs) to be filled with the for loop
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below makes year 0 become year 1 in the matrix
proj_year[1, ] <- fish_year0

# The for loop below is using year 2-8 to calculate the leslie projections for each year
